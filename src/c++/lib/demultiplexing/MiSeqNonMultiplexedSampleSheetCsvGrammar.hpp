 ...
 **
 ** \file MiSeqNonMultiplexedSampleSheetCsvGrammar.hpp
 **
...
#ifndef iSAAC_DEMULTIPLEXING_MISEQ_NONMULTIPLEXED_SAMPLE_SHEET_CSV_GRAMMAR_HH
#define iSAAC_DEMULTIPLEXING_MISEQ_NONMULTIPLEXED_SAMPLE_SHEET_CSV_GRAMMAR_HH
...
struct MiSeqNonMultiplexedSampleSheetCsvGrammar :
    MiSeqSampleSheetCsvGrammar<Iterator>,
    bs::qi::grammar<Iterator, flowcell::BarcodeMetadataList()>
{
        MiSeqNonMultiplexedSampleSheetCsvGrammar(const flowcell::SequencingAdapterMetadataList &defaultAdapters) :
            MiSeqNonMultiplexedSampleSheetCsvGrammar::base_type(start_)
    {
...
//        using boost::phoenix::insert;
        ...
        column_header_ = string("Sample_ID,Sample_Name,GenomeFolder") >>
...
#endif //iSAAC_DEMULTIPLEXING_MISEQ_NONMULTIPLEXED_SAMPLE_SHEET_CSV_GRAMMAR_HH
